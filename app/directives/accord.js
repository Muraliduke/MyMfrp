...
.directive('accordian',function(){
	...
	return{
		...
		//template:"<h1>{{myattr.firstName}}</h1>",//give attribute myattr for fetching the values dnt use v or data
		templateUrl:"pages/tt.html",
		...
		replace: true, /* to wrap all dom element in a div  and mak sure atleast 1 root element div is ter in template */
